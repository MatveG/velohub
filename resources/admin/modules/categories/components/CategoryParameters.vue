<template>
    <div>
        <b-table class="table-valign-center"
                 ref="table"
                 :data="(action === 'add') ? [...items, currItem] : items"
                 default-sort="ord"
            ...
            <template v-slot="props">
                ...
                <b-table-column field="title" label="Название" width="25%" sortable>
                    <b-field v-if="props.row.index === currItem.index" :type="{ 'is-danger': $v.currItem.title.$error }">
                ...
                <b-table-column field="type" label="Тип данных" width="25%" sortable centered>
                    <template v-if="props.row.index === currItem.index">
                ...
                <b-table-column field="is_filter" label="Фильтр" width="10%" sortable centered>
                    <b-checkbox v-if="props.row.index === currItem.index" v-model="currItem.is_filter"
