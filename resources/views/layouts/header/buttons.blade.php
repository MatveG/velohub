<div class="p-3 text-center" id="info-btn-group">
    <button class="btn navbar-icon-btn icon-30 icon-phone" data-bs-parent="#navbar-info"
            data-bs-target="#navbar-info-phone" data-bs-toggle="collapse"></button>
    <button class="btn navbar-icon-btn icon-30 icon-search" data-bs-parent="#navbar-info"
