<div id="navbar-info">
{{--    <div id="navbar-info-phone" class="collapse navbar-info" data-parent="#navbar-info">--}}
{{--        <div class="row">--}}
{{--            <div class="col-1"></div>--}}
...
{{--                        data-bs-target="#navbar-info-phone"/>--}}
{{--            </div>--}}
{{--        </div>--}}
{{--    </div>--}}

    <div id="navbar-info-search" class="collapse navbar-info" data-parent="#navbar-info">
        <div class="row">
            <div class="col-1"></div>
            <div class="col-10 navbar-info-body">
            ...
            <div class="col-1 align-self-center">
                <button class="btn-close"
                        data-bs-toggle="collapse"
                        data-bs-target="#navbar-info-search" />
            </div>
        </div>
    </div>
</div>
