...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _core_class__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./core.class */ \"./resources/js/core.class.js\");\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\n\n\nvar Compare =\n/*#__PURE__*/\nfunction () {\n  function Compare() {\n    _classCallCheck(this, Compare);\n\n    var cookie = _core_class__WEBPACK_IMPORTED_MODULE_0__[\"default\"].getCookie('compare');\n    this.items = cookie && cookie.length ? JSON.parse(decodeURIComponent(cookie)) : [];\n  }\n\n  _createClass(Compare, [{\n    key: \"add\",\n    value: function add(id) {\n      if (this.items.includes(id)) return;\n      this.items.push(id);\n      this.save();\n    }\n  }, {\n    key: \"remove\",\n    value: function remove(id) {\n      this.items = this.items.filter(function (el) {\n        return el !== id;\n      });\n      this.save();\n    }\n  }, {\n    key: \"save\",\n    value: function save() {\n      _core_class__WEBPACK_IMPORTED_MODULE_0__[\"default\"].setCookie('compare', encodeURIComponent(JSON.stringify(this.items)), 30);\n    }\n  }, {\n    key: \"reset\",\n    value: function reset() {\n      this.items = [];\n      _core_class__WEBPACK_IMPORTED_MODULE_0__[\"default\"].clearCookie('compare');\n    }\n  }, {\n    key: \"check\",\n    value: function check(id) {\n      return this.items.includes(id);\n    }\n  }]);\n\n  return Compare;\n}();\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (new Compare());\n\n//# sourceURL=webpack:///./resources/js/compare.class.js?");
